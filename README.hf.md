...
datasets:
  - open-mental-health-dialogues
  - openai-synthetic-coaching-dialogues
  - synthetic-coaching-conversations
model-index:
  - name: CogniXpert-Model-v1.0
    results: 
      - task: 
        ...
        dataset:
          type: mixed
          name: Open MH Dialogues + Synthetic Coaching
        metrics:
          - type: qualitative
            value: human-eval
            name: Safety-aligned helpfulness
---
